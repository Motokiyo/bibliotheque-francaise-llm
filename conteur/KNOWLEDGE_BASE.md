...
Contraintes techniques validées terrain. Référence canonique pour tout projet voix d'Alexandre : `/IA/Modeles/openai-realtime-2-bible-vocale.md`.
...
- Bible vocale canonique : `/IA/Modeles/openai-realtime-2-bible-vocale.md` (13 sections)
- MAP.md reachy_care : `RD/Eiffel/reachy_care/app/MAP.md §8 CONFIG OPENAI REALTIME`
